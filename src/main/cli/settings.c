...
// PG_OSD_CONFIG
    ...
    { "osd_art7_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 8 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[6].frames) },
    ...
    { "osd_art8_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 8 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[7].frames) },
    ...
    { "osd_art9_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 8 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[8].frames) },
    ...
    { "osd_art10_frames",       VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 8 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[9].frames) },
