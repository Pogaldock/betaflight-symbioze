...
const char * const lookupTableOsdArtSource[] = {
    "TIME", "THROTTLE", "RSSI", "BATTERY"
};
#endif
...
const lookupTableEntry_t lookupTables[] = {
    ...
    LOOKUP_TABLE_ENTRY(lookupTableOsdArtSource), // SYMBIOZE
#endif
#ifdef USE_RX_EXPRESSLRS
...
// PG_OSD_CONFIG
    ...
    // SYMBIOZE: art elements 1-10 â€” position + glyph block + animation + v6 extras
    ...
    { "osd_art1_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 64 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[0].frames) },
    { "osd_art1_period",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[0].period) },
    { "osd_art1_stride",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[0].stride) },
    { "osd_art1_blink",         VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[0].blink) },
    { "osd_art1_source",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OSD_ART_SOURCE }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[0].source) },
    { "osd_art1_mapped",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[0].mapped) },
    { "osd_art1_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_ART_MAP_POOL - 1 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[0]) },
    ...
    { "osd_art2_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 64 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[1].frames) },
    { "osd_art2_period",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[1].period) },
    { "osd_art2_stride",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[1].stride) },
    { "osd_art2_blink",         VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[1].blink) },
    { "osd_art2_source",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OSD_ART_SOURCE }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[1].source) },
    { "osd_art2_mapped",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[1].mapped) },
    { "osd_art2_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_ART_MAP_POOL - 1 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[1]) },
    ...
    { "osd_art3_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 64 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[2].frames) },
    { "osd_art3_period",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[2].period) },
    { "osd_art3_stride",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[2].stride) },
    { "osd_art3_blink",         VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[2].blink) },
    { "osd_art3_source",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OSD_ART_SOURCE }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[2].source) },
    { "osd_art3_mapped",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[2].mapped) },
    { "osd_art3_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_ART_MAP_POOL - 1 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[2]) },
    ...
    { "osd_art4_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 64 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[3].frames) },
    { "osd_art4_period",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[3].period) },
    { "osd_art4_stride",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[3].stride) },
    { "osd_art4_blink",         VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[3].blink) },
    { "osd_art4_source",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OSD_ART_SOURCE }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[3].source) },
    { "osd_art4_mapped",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[3].mapped) },
    { "osd_art4_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_ART_MAP_POOL - 1 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[3]) },
    ...
    { "osd_art5_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 64 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[4].frames) },
    { "osd_art5_period",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[4].period) },
    { "osd_art5_stride",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[4].stride) },
    { "osd_art5_blink",         VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[4].blink) },
    { "osd_art5_source",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OSD_ART_SOURCE }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[4].source) },
    { "osd_art5_mapped",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[4].mapped) },
    { "osd_art5_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_ART_MAP_POOL - 1 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[4]) },
    ...
    { "osd_art6_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 64 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[5].frames) },
    { "osd_art6_period",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[5].period) },
    { "osd_art6_stride",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[5].stride) },
    { "osd_art6_blink",         VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[5].blink) },
    { "osd_art6_source",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OSD_ART_SOURCE }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[5].source) },
    { "osd_art6_mapped",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[5].mapped) },
    { "osd_art6_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_ART_MAP_POOL - 1 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[5]) },
    { "osd_art7_pos",           VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_ART6]) },
    { "osd_art7_glyph",         VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[6].glyph) },
    { "osd_art7_cols",          VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, OSD_ART_MAX_COLS }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[6].cols) },
    { "osd_art7_rows",          VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, OSD_ART_MAX_ROWS }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[6].rows) },
    { "osd_art7_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 64 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[6].frames) },
    { "osd_art7_period",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[6].period) },
    { "osd_art7_stride",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[6].stride) },
    { "osd_art7_blink",         VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[6].blink) },
    { "osd_art7_source",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OSD_ART_SOURCE }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[6].source) },
    { "osd_art7_mapped",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[6].mapped) },
    { "osd_art7_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_ART_MAP_POOL - 1 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[6]) },
    { "osd_art8_pos",           VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_ART7]) },
    { "osd_art8_glyph",         VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[7].glyph) },
    { "osd_art8_cols",          VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, OSD_ART_MAX_COLS }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[7].cols) },
    { "osd_art8_rows",          VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, OSD_ART_MAX_ROWS }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[7].rows) },
    { "osd_art8_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 64 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[7].frames) },
    { "osd_art8_period",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[7].period) },
    { "osd_art8_stride",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[7].stride) },
    { "osd_art8_blink",         VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[7].blink) },
    { "osd_art8_source",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OSD_ART_SOURCE }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[7].source) },
    { "osd_art8_mapped",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[7].mapped) },
    { "osd_art8_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_ART_MAP_POOL - 1 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[7]) },
    { "osd_art9_pos",           VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_ART8]) },
    { "osd_art9_glyph",         VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[8].glyph) },
    { "osd_art9_cols",          VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, OSD_ART_MAX_COLS }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[8].cols) },
    { "osd_art9_rows",          VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, OSD_ART_MAX_ROWS }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[8].rows) },
    { "osd_art9_frames",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 64 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[8].frames) },
    { "osd_art9_period",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[8].period) },
    { "osd_art9_stride",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[8].stride) },
    { "osd_art9_blink",         VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[8].blink) },
    { "osd_art9_source",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OSD_ART_SOURCE }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[8].source) },
    { "osd_art9_mapped",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[8].mapped) },
    { "osd_art9_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_ART_MAP_POOL - 1 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[8]) },
    { "osd_art10_pos",          VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_ART9]) },
    { "osd_art10_glyph",        VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[9].glyph) },
    { "osd_art10_cols",         VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, OSD_ART_MAX_COLS }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[9].cols) },
    { "osd_art10_rows",         VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, OSD_ART_MAX_ROWS }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[9].rows) },
    { "osd_art10_frames",       VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 64 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[9].frames) },
    { "osd_art10_period",       VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 1, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[9].period) },
    { "osd_art10_stride",       VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[9].stride) },
    { "osd_art10_blink",        VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[9].blink) },
    { "osd_art10_source",       VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OSD_ART_SOURCE }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[9].source) },
    { "osd_art10_mapped",       VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, art[9].mapped) },
    { "osd_art10_mapstart",     VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_ART_MAP_POOL - 1 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[9]) },
