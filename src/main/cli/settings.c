...
// PG_OSD_CONFIG
    ...
    // SYMBIOZE: art elements 1-10 — position + glyph block + animation + v6 extras
    ...
    { "osd_art1_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 383 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[0]) },
    ...
    { "osd_art2_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 383 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[1]) },
    ...
    { "osd_art3_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 383 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[2]) },
    ...
    { "osd_art4_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 383 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[3]) },
    ...
    { "osd_art5_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 383 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[4]) },
    ...
    { "osd_art6_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 383 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[5]) },
    ...
    { "osd_art7_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 383 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[6]) },
    ...
    { "osd_art8_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 383 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[7]) },
    ...
    { "osd_art9_mapstart",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 383 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[8]) },
    ...
    { "osd_art10_mapstart",     VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 383 }, PG_OSD_CONFIG, offsetof(osdConfig_t, artMapStart[9]) },
